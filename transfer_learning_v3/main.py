...
def main(args):
    ...
    directories = (
        f'logs/urb_{timestamp}',
        f'logs/urb_{timestamp}/training_losses',
        f'logs/urb_{timestamp}/best_model',
        f'logs/urb_{timestamp}/metadata'
    )
    ...
    config = {
        "ANNOTATIONS_FILE":  "../urb_data/raw/metadata/metadata.csv",
        "AUDIO_DIR": f"../urb_data/preprocessed/{args.features}",
